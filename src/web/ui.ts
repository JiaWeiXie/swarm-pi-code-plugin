...
import { CUSTOM_ENDPOINT_GUIDANCE, type ProviderFieldGuidance } from "../providers/capabilities.js";
...
function guidanceMarkup(guidance: ProviderFieldGuidance | undefined): string {
  if (!guidance) return "";
