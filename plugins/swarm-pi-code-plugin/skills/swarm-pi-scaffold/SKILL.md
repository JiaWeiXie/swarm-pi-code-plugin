...
4. Allow only an exact, in-scope, fully reversible staging action with rollback and verification; keep adoption and materialization as explicit user decisions.
