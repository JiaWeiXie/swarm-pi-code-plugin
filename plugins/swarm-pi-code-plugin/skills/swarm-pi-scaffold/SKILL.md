...
4. Inspect every complete WorkerAssessment, trusted runtime `effectAssessment`, and adjudication context. Treat runtime effects as authoritative and Worker prose as advisory. Allow only an exact, in-scope, fully reversible staging action with rollback and verification; keep adoption and materialization as explicit user decisions.
