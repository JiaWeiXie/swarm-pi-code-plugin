...
4. Require explicit approval for lifecycle scripts, native builds, and unknown network sources. Keep global installs, host provisioning, deployment, and Git delivery denied.
