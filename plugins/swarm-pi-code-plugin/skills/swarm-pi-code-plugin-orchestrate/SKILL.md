...
The coordinator may choose direct review or a bounded virtual panel according to the snapped Decision Mode. Advisor participation is optional, context-only, and quota-limited; it cannot override policy, verification, or user gates.
...
6. Reconcile every selected perspective (direct review, bounded panel, and any optional Advisor consultation) against repository evidence, identify disagreements, and present one coherent conclusion with the source job ID.
